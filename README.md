...
| `--in` | Project path to the Xojo project item(s). | Explicitly includes project items in output. Multiple values should be separated by a semicolon (`;`) | `--in=Classes/Windows/*;Classes/ProjectReader/ImportThread` |
